...
<div class="row g-4">
    ...
    <div class="col-12 col-xl-5">
        <x-card title="Nueva Publicación" class="ebt-post-form-card sticky-top" style="top: 80px">
        ...
        @else
            <div class="d-flex flex-column gap-3">
                @foreach ($project->posts as $post)
                    <x-card class="ebt-admin-post-card">
...
<x-modal id="modal-image-viewer" title="Vista de imagen" size="xl">
    ...
    <x-slot:footer>
        ...
        <a id="btn-viewer-download" href="#" download class="btn btn-outline-light" target="_blank">
